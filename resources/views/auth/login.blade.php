                    ...
                    <div class="col-lg-4 mx-auto">
                        <div class="card">
                            ...
                            <div class="card-body pt-0">
                                <form class="my-4" action="{{route('login410-EK')}}" method="post">
                                    @csrf
...
<!-- Mirrored from mannatthemes.com/metrica/default/auth-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 03 Nov 2023 10:04:32 GMT -->
</html>
