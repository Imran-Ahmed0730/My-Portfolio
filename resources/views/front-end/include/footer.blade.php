    ...
    <footer class="footer p-3 pt-4">
        <div class="row" id="contact">
            ...
            <div class="col-md-5 msg-form mb-5">
                ...
                <form action="{{route('message')}}" method="post" id="messageForm">
                    @csrf
                    <div class="form-group row mb-3">
                        <label for="name" class="col-sm-2 col-form-label">Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" id="message_name" placeholder="Your Name" required>
                        </div>
                    </div>
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="message" rows="5" id="massage" placeholder="Your Message" required></textarea>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <button type="submit" class="sub-btn btn g-recaptcha" data-sitekey="{{config('services.recaptcha.site_key')}}"
                                    data-callback="onMessageSubmit"
        ...
        <div class="row">
            <div class="col-md-12">
                <p align="center" class="copyright">Designed & Developed By Imran Ahmed | Copyright &copy {{date('Y')}}. All Rights Are Reserved</p>
            </div>
        </div>
    </footer>
</div>
